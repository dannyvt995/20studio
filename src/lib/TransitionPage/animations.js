...
const animations = {
  ...
  rotateRoomTopOut: {
    keyframes: keyframes`
      ...
      to { opacity: 1; transform: translateY(0%) rotateX(0deg);clip-path: polygon(0 0, 100% 0, 100% 0, 0 0) }
    `,
    duration: 1800,
    timing: 'ease',
    fill: 'both',
  ...
  rotateRoomTopIn: {
    keyframes: keyframes`
      from { opacity: 1; transform: translateY(0%) rotateX(0deg);clip-path: polygon(0 0, 100% 0, 100% 100%, 0% 100%) }
