  ...
  return (
    <section className='project_text has-padding-bottom'>
        ...
        <h2 className="title is-normal">
            ...
            <div className="title-line">show selection</div>
        </h2>
        <h2 className='label'>
         ...
         <div className="body"><p><span className="">To leave a lasting impression, we have created a custom horizontal scroll page that allows visitors to scroll through the shows while they are tantalized by beautiful visuals, encouraging them to explore further.</span></p></div>
        </div>
    </section>
  )
}
